...
//     <div>
//       {cart.length > 0 ? 
//       <Fragment className="w-1/4 top-0 left-80 mx-auto right-8 border-0 outline-0"
//       >
//           <Dialog
//             className="w-1/4 top-0 left-80 mx-auto right-8 border-0 outline-0"
//             open={openModal}
...
//         <Fragment>
//           <Dialog
//             className="w-1/2 top-80 left-80 mx-8 right-80 border-0 outline-0"
//             open={openModal}
//             handler={() => setOpen(false)}
//             animate={{
//               mount: { scale: 1, y: 0 },
...
//                 <p className="text-black text-base font-inter tracking-normal leading-none py-4">Kindly add some products</p>
//               </div>
//             </DialogBody>
//           </Dialog>
//         </Fragment>}
